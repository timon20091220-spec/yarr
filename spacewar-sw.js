const CACHE_NAME='space-arcade-v13-24-2-20260818163712';
const SHELL=['./','./index.html','./manifest.webmanifest?v=13.24.2','./spacewar-icon-192.png','./spacewar-icon-512.png'];
