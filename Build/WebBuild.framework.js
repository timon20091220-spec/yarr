...
// include: C:/Program Files/Unity/Hub/Editor/6000.5.8f1/Editor/Data/PlaybackEngines/WebGLSupport/BuildTools/UserJsprePlaceholder.js


// end include: C:/Program Files/Unity/Hub/Editor/6000.5.8f1/Editor/Data/PlaybackEngines/WebGLSupport/BuildTools/UserJsprePlaceholder.js
// include: C:/Program Files/Unity/Hub/Editor/6000.5.8f1/Editor/Data/PlaybackEngines/WebGLSupport/BuildTools/prejs/AnimationFrameRate.js
...
// end include: C:/Program Files/Unity/Hub/Editor/6000.5.8f1/Editor/Data/PlaybackEngines/WebGLSupport/BuildTools/prejs/AnimationFrameRate.js
// include: C:/Program Files/Unity/Hub/Editor/6000.5.8f1/Editor/Data/PlaybackEngines/WebGLSupport/BuildTools/prejs/Error.js
...
// end include: C:/Program Files/Unity/Hub/Editor/6000.5.8f1/Editor/Data/PlaybackEngines/WebGLSupport/BuildTools/prejs/Error.js
// include: C:/Program Files/Unity/Hub/Editor/6000.5.8f1/Editor/Data/PlaybackEngines/WebGLSupport/BuildTools/prejs/FullScreen.js
...
// end include: C:/Program Files/Unity/Hub/Editor/6000.5.8f1/Editor/Data/PlaybackEngines/WebGLSupport/BuildTools/prejs/FullScreen.js
// include: C:/Program Files/Unity/Hub/Editor/6000.5.8f1/Editor/Data/PlaybackEngines/WebGLSupport/BuildTools/prejs/IdbFs.js
if (typeof ENVIRONMENT_IS_PTHREAD === 'undefined' || !ENVIRONMENT_IS_PTHREAD) {
...
// end include: C:/Program Files/Unity/Hub/Editor/6000.5.8f1/Editor/Data/PlaybackEngines/WebGLSupport/BuildTools/prejs/IdbFs.js
// include: C:/Program Files/Unity/Hub/Editor/6000.5.8f1/Editor/Data/PlaybackEngines/WebGLSupport/BuildTools/prejs/MediaDevices.js
...
// end include: C:/Program Files/Unity/Hub/Editor/6000.5.8f1/Editor/Data/PlaybackEngines/WebGLSupport/BuildTools/prejs/MediaDevices.js
// include: C:/Program Files/Unity/Hub/Editor/6000.5.8f1/Editor/Data/PlaybackEngines/WebGLSupport/BuildTools/prejs/PlayerConnection.js
...
// end include: C:/Program Files/Unity/Hub/Editor/6000.5.8f1/Editor/Data/PlaybackEngines/WebGLSupport/BuildTools/prejs/PlayerConnection.js
// include: C:/Program Files/Unity/Hub/Editor/6000.5.8f1/Editor/Data/PlaybackEngines/WebGLSupport/BuildTools/prejs/SendMessage.js
...
// end include: C:/Program Files/Unity/Hub/Editor/6000.5.8f1/Editor/Data/PlaybackEngines/WebGLSupport/BuildTools/prejs/SendMessage.js
// include: C:/Program Files/Unity/Hub/Editor/6000.5.8f1/Editor/Data/PlaybackEngines/WebGLSupport/BuildTools/prejs/WebPlayerInitilization.js
...
// end include: C:/Program Files/Unity/Hub/Editor/6000.5.8f1/Editor/Data/PlaybackEngines/WebGLSupport/BuildTools/prejs/WebPlayerInitilization.js
...
// Begin JS library code
  ...
  initPromise:null,
  config:{
  apiKey:"AIzaSyAr5CmjFd9_SSEUclhknsT6RBbRWD3puJ4",
  authDomain:"space-war-9e240.firebaseapp.com",
  projectId:"space-war-9e240",
  storageBucket:"space-war-9e240.firebasestorage.app",
  messagingSenderId:"314491732348",
  appId:"1:314491732348:web:c6d04ea66ad97602b464f9",
  },
  ensureState:function() {
        if (SWFBWeb.state) return Promise.resolve(SWFBWeb.state);
        if (SWFBWeb.initPromise) return SWFBWeb.initPromise;
  
        SWFBWeb.initPromise = Promise.all([
          ...
          var authM = mods[1];
          var fsM = mods[2];
          var app = appM.getApps().length ? appM.getApp() : appM.initializeApp(SWFBWeb.config);
          var auth = authM.getAuth(app);
          var db = fsM.getFirestore(app);
          SWFBWeb.state = { appM: appM, authM: authM, fsM: fsM, app: app, auth: auth, db: db };
  
          // 최초 실행에서 저장된 로그인 세션 복구가 끝날 때까지 기다립니다.
          await new Promise(function(resolve) {
            var finished = false;
            var unsub = null;
            unsub = authM.onAuthStateChanged(auth, function() {
              if (finished) return;
              finished = true;
              if (unsub) unsub();
              resolve();
          ...
          return SWFBWeb.state;
        }).catch(function(err) {
          SWFBWeb.initPromise = null;
          throw err;
        });
  
        return SWFBWeb.initPromise;
      },
  ...
  friendlyError:function(err) {
        ...
        if (code === "auth/popup-blocked") return "브라우저가 Google 로그인 팝업을 차단했습니다. 팝업을 허용해주세요.";
        if (code === "auth/unauthorized-domain") return "현재 웹 주소가 Firebase 승인 도메인에 등록되지 않았습니다.";
        if (code === "auth/account-exists-with-different-credential") return "같은 이메일의 기존 계정이 있습니다. 기존 로그인 방식으로 먼저 로그인해주세요.";
        ...
        var msg = (err && err.message) ? String(err.message) : String(err || "알 수 없는 오류");
        return code ? (code + ": " + msg) : msg;
      },
  send:function(requestId, ok, message, data) {
        if (!requestId) return;
        var msg = encodeURIComponent(message || "");
        var json = encodeURIComponent(JSON.stringify(data || {}));
        SendMessage("SpaceWarWebFirebaseBridge", "OnWebFirebaseResult", String(requestId) + "|" + (ok ? "1" : "0") + "|" + msg + "|" + json);
      },
  run:function(requestId, fn) {
        SWFBWeb.ensureState().then(function(state) {
          return fn(state);
        }).then(function(data) {
          SWFBWeb.send(requestId, true, "", data || {});
        }).catch(function(err) {
          SWFBWeb.send(requestId, false, SWFBWeb.friendlyError(err), {});
        });
      },
  betterRun:function(nTime, nKills, nLevel, oTime, oKills, oLevel) {
        if (nTime > oTime + 0.0001) return true;
        if (nTime < oTime - 0.0001) return false;
        if (nKills !== oKills) return nKills > oKills;
        return nLevel > oLevel;
      },
  };
  
  function _SWFB_CreateProfile(requestId, nicknamePtr, privacyAccepted) {
      var nickname = UTF8ToString(nicknamePtr);
      SWFBWeb.run(requestId, async function(s) {
        var user = s.auth.currentUser;
        if (!user) throw new Error("로그인이 필요합니다.");
        var ref = s.fsM.doc(s.db, "users", user.uid);
        await s.fsM.setDoc(ref, {
          nickname: nickname,
          privacyAccepted: !!privacyAccepted,
          bestSurvival: 0,
          bestKills: 0,
          bestLevel: 1,
          createdAt: s.fsM.serverTimestamp(),
          updatedAt: s.fsM.serverTimestamp()
        }, { merge: true });
        return {};
      });
    }

  function _SWFB_Initialize(requestId) {
      SWFBWeb.ensureState().then(function(state) {
        SWFBWeb.send(requestId, true, "", SWFBWeb.userData(state.auth.currentUser));
      }).catch(function(err) {
        SWFBWeb.send(requestId, false, "웹 Firebase 초기화 실패: " + SWFBWeb.friendlyError(err), {});
      });
    }

  function _SWFB_LoadLeaderboard(requestId) {
      SWFBWeb.run(requestId, async function(s) {
        if (!s.auth.currentUser) throw new Error("로그인이 필요합니다.");
        var snap = await s.fsM.getDocs(s.fsM.collection(s.db, "leaderboard"));
        var entries = [];
        snap.forEach(function(docSnap) {
          var d = docSnap.data() || {};
          entries.push({
            nickname: d.nickname || "파일럿",
  ...
  function _SWFB_LoadProfile(requestId) {
      SWFBWeb.run(requestId, async function(s) {
        var user = s.auth.currentUser;
        if (!user) throw new Error("로그인이 필요합니다.");
        var snap = await s.fsM.getDoc(s.fsM.doc(s.db, "users", user.uid));
        if (!snap.exists()) return { exists: false };
        var d = snap.data() || {};
        return {
          exists: true,
          nickname: d.nickname || "파일럿",
          bestSurvival: Number(d.bestSurvival || 0),
          bestKills: Number(d.bestKills || 0),
          bestLevel: Math.max(1, Number(d.bestLevel || 1))
        };
      });
    }

  
  function _SWFB_LoginEmail(requestId, emailPtr, passwordPtr) {
      var email = UTF8ToString(emailPtr);
      var password = UTF8ToString(passwordPtr);
      SWFBWeb.run(requestId, async function(s) {
        var cred = await s.authM.signInWithEmailAndPassword(s.auth, email, password);
        return SWFBWeb.userData(cred.user);
      });
    }

  function _SWFB_LoginGoogle(requestId) {
      // Popup은 사용자 클릭 이벤트 안에서 바로 열어야 하므로 await 전에 호출합니다.
      try {
        var s = SWFBWeb.state;
        if (!s) {
          SWFBWeb.send(requestId, false, "Firebase가 아직 준비되지 않았습니다. 잠시 후 다시 눌러주세요.", {});
          return;
        }
        var provider = new s.authM.GoogleAuthProvider();
        provider.addScope("email");
        provider.addScope("profile");
        s.authM.signInWithPopup(s.auth, provider).then(function(result) {
          SWFBWeb.send(requestId, true, "", SWFBWeb.userData(result.user));
        }).catch(function(err) {
          SWFBWeb.send(requestId, false, SWFBWeb.friendlyError(err), {});
        });
      } catch (err) {
  ...
  function _SWFB_Logout() {
      try {
        if (SWFBWeb.state) SWFBWeb.state.authM.signOut(SWFBWeb.state.auth);
      } catch (e) { }
    }

  
  function _SWFB_RegisterEmail(requestId, emailPtr, passwordPtr) {
      var email = UTF8ToString(emailPtr);
      var password = UTF8ToString(passwordPtr);
      SWFBWeb.run(requestId, async function(s) {
        var cred = await s.authM.createUserWithEmailAndPassword(s.auth, email, password);
        return SWFBWeb.userData(cred.user);
      });
    }

  
  function _SWFB_SubmitRun(requestId, nicknamePtr, survival, kills, level) {
      var nickname = UTF8ToString(nicknamePtr);
      SWFBWeb.run(requestId, async function(s) {
        var user = s.auth.currentUser;
        if (!user) throw new Error("로그인이 필요합니다.");
        var ref = s.fsM.doc(s.db, "leaderboard", user.uid);
        var snap = await s.fsM.getDoc(ref);
        var nTime = Math.max(0, Number(survival || 0));
        var nKills = Math.max(0, Number(kills || 0));
        var nLevel = Math.max(1, Number(level || 1));
  
        if (snap.exists()) {
          var old = snap.data() || {};
          var better = SWFBWeb.betterRun(nTime, nKills, nLevel,
            Number(old.survival || 0), Number(old.kills || 0), Math.max(1, Number(old.level || 1)));
          if (!better) return {};
        }
  
        await s.fsM.setDoc(ref, {
          nickname: nickname || "파일럿",
          survival: nTime,
          kills: nKills,
          level: nLevel,
          updatedAt: s.fsM.serverTimestamp()
  ...
  function _SWFB_UpdateBest(requestId, bestSurvival, bestKills, bestLevel) {
      SWFBWeb.run(requestId, async function(s) {
        var user = s.auth.currentUser;
        if (!user) throw new Error("로그인이 필요합니다.");
        await s.fsM.setDoc(s.fsM.doc(s.db, "users", user.uid), {
          bestSurvival: Math.max(0, Number(bestSurvival || 0)),
          bestKills: Math.max(0, Number(bestKills || 0)),
          bestLevel: Math.max(1, Number(bestLevel || 1)),
          updatedAt: s.fsM.serverTimestamp()
        }, { merge: true });
        return {};
      });
...
var wasmImports = {
  ...
  /** @export */
  SWFB_CreateProfile: _SWFB_CreateProfile,
  /** @export */
  SWFB_Initialize: _SWFB_Initialize,
  /** @export */
  SWFB_LoadLeaderboard: _SWFB_LoadLeaderboard,
  /** @export */
  SWFB_LoadProfile: _SWFB_LoadProfile,
  /** @export */
  SWFB_LoginEmail: _SWFB_LoginEmail,
  /** @export */
  SWFB_LoginGoogle: _SWFB_LoginGoogle,
  /** @export */
  SWFB_Logout: _SWFB_Logout,
  /** @export */
  SWFB_RegisterEmail: _SWFB_RegisterEmail,
  /** @export */
  SWFB_SubmitRun: _SWFB_SubmitRun,
  /** @export */
  SWFB_UpdateBest: _SWFB_UpdateBest,
  /** @export */
